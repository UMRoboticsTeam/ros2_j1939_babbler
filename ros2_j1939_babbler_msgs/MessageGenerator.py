...
def convert_files(db: cantools.database.Database, msg_output_dir: str, type_conversion_output: str):
...
def generate_type_conversions(messages: list[cantools.database.Message], type_conversion_output: str):
    with open(type_conversion_output, "w") as f:
        ...
        for message in messages:
            ...
            can_msg_type_name = f"_{CodeGenMessage(message).snake_name}_t"  # Distilled from c_source.py
            pack_function_name = f"_{CodeGenMessage(message).snake_name}_pack"  # Also distilled
